//package com.dream.web.controller.front;
//
...
//import com.dream.web.service.user.UserStatusHistoryService;
//
///**
// * User: xiaorui.lu 
// * Date: 2013年12月18日 下午8:44:22
// */
//@Controller
...
//    // 这样会导致登录一直死循环
//    Subject subject = SecurityUtils.getSubject();   // 几乎所有的环境下，都可以通过这种方式获取当前用户
